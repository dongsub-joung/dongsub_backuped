...
*자본주의가 인간 자체를 부정하고 대체제로 일시적인 조치를 취하고 기만하는데 이러한 것에 동조해서 인간은 같은 인간을 기만한다. 그렇기 때문에 이 모든 것들이 기만이다. 그리고 이러한 사실을 아는 나는 인간이고, 한 개인의 영향력과 행동력은 한계가 있으며, 세상의 기만자들은 자본이라는 자본주의에서의 확고한 권력을 가지고 있음을 절실히 깨닫는다. 그리고 다시 돌아온다. 만약 인간이 혹시 어쩌면 ... 그리고 1인의 영향력이 가장 큰, 그리고 개인주의가 만연해지고 있는 지금이라면 인간이라는 존재를 확연하게 원하지만 대체제로 인해서 행동하지 못하는 사람들이 많아지고, 많다면 그 개인들 하나하나의 의식의 변화를 통한 행동들은 사회에 어떠한 변화를 가져올 것이라고 생각한다. 우리는 자본이라는 권력을 쥐고 있으며 기만자들에게 모든 것을 부정당한 구 시대의 사람들을 뛰어 넘어서야 한다.*

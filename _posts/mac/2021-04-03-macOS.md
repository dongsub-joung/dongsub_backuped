...
![hybrid kernel img](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Windows_2000_architecture.svg/1280px-Windows_2000_architecture.svg.png)
...
- - - -
# 참고 사이트
* [iOS 14 - 기능 - Apple (KR)](https://www.apple.com/kr/ios/ios-14/features/)
* [iOS 14 - Apple Developer](https://developer.apple.com/kr/ios/)
* [네이버 지식백과: iOS](https://terms.naver.com/entry.nhn?docId=3340565) 
* [iOS - 위키백과, 우리 모두의 백과사전](https://ko.wikipedia.org/wiki/IOS)
* [BSD - 위키백과, 우리 모두의 백과사전](https://ko.wikipedia.org/wiki/BSD)
* [Darwin wiki](https://en.wikipedia.org/wiki/Darwin_(operating_system))
* [BSD Overview - Apple Developer](https://developer.apple.com/library/archive/documentation/Darwin/Conceptual/KernelProgramming/BSD/BSD.html)
* [IOS wiki](https://en.wikipedia.org/wiki/IOS)
* [XNU wiki](https://en.wikipedia.org/wiki/XNU)
